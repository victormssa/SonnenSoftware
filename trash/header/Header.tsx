...
import headerLogoBlack from "./../../assets/imgs/headerLogoBlack.png";
import headerLogoWhite from "./../../assets/imgs/headerLogoWhite.png";
...
const Navigation = () => {
  ...
  return (
    <nav className="fixed w-full bg-white shadow dark:bg-[#101010] z-10">
      <div className="container px-6 py-4 mx-auto">
        <div className="lg:flex lg:items-center lg:justify-between">
          <div className="flex items-center justify-between">
            <Link to="/pt-br" className="flex items-center justify-between">
              <img
                className={`w-22 h-10 ${logoDM()}`}
