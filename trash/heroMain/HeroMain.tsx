...
import storeImage from "../../assets/imgs/storeImage.jpg";
import optimizationImage from "../../assets/imgs/optimizationImage.jpg";
import solutionImage from "../../assets/imgs/solutionImage.jpg";
import appImage from "../../assets/imgs/appImage.jpg";
...
const HeroMain = () => {
  const textOptions = ['Site', 'Aplicativo', 'Sistema'];
  return (
    <>
      <main
            ...
            <div className="container px-6 py-10 mx-auto">
              ...
              <div className="mt-4 xl:mt-4 lg:flex lg:items-center">
                <div className="grid w-full grid-cols-1 gap-8 xl:gap-16 md:grid-cols-4">
                  ...
                  <Link className=" w-full bg-center bg-[length:450px_300px] h-full rounded-md filter hover:bg-[length:500px_350px] transition-all duration-150" style={{backgroundImage: `url(${appImage})`}} to='/pt-br/sobre-sites'>
                  <div className="space-y-3 w-full h-full px-2 py-2 rounded-md bg-[#000000]/80">
                  ...
                  <Link className="w-full bg-center bg-[length:300px_250px] h-full rounded-md filter  hover:bg-[length:350px_300px] transition-all duration-150" style={{backgroundImage: `url(${optimizationImage})`}} to='/pt-br/sobre-sites'>
                  <div className="space-y-3 w-full h-full px-2 py-2 rounded-md bg-[#000000]/80">
                    <span className="inline-block p-3 text-red-500 bg-red-100 rounded-xl dark:text-white dark:bg-red-500">
                    <FaWrench size='1.5em'/>
                    </span>
                  ...
                  <Link className="w-full bg-center bg-[length:300px_250px] h-full rounded-md filter hover:bg-[length:350px_300px] transition-all duration-150" style={{backgroundImage: `url(${solutionImage})`}} to='/pt-br/sobre-sites'>
                  <div className="space-y-3 w-full h-full px-2 py-2 rounded-md bg-[#000000]/80">
                    <span className="inline-block p-3 text-red-500 bg-red-100 rounded-xl dark:text-white dark:bg-red-500">
